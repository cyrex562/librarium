...
const PROSE_BEGIN: &str = "<!-- librarium:prose:begin -->";
const PROSE_END: &str = "<!-- librarium:prose:end -->";
const LEGACY_PROSE_BEGIN: &str = "<!-- codex:prose:begin -->";
const LEGACY_PROSE_END: &str = "<!-- codex:prose:end -->";
